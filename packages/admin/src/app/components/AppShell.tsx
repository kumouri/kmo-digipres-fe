...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: "/revenue-revive", label: "Revenue revive", icon: HeartPulse, hideForContractor: true },
  { to: "/switchboard", label: "Switchboard AI", icon: PhoneCall, hideForContractor: true },
  { to: "/reschedule-waitlist", label: "Reschedule waitlist", icon: CalendarCheck, hideForContractor: true },
